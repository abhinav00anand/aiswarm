# Blynx Release Changelog

All notable changes to **Blynx** are documented here.
...
### 🚀 Initial Open-Source Release of Blynx
...
- **Security Subsystem**:
  ...
  - `AuditLedger`: Thread-safe, append-only event logging (`~/.blynx/audit.jsonl`).
...
- Published initial package `blynx` on PyPI ([https://pypi.org/project/blynx/](https://pypi.org/project/blynx/)).
- Created official GitHub repository ([https://github.com/abhinav00anand/blynx](https://github.com/abhinav00anand/blynx)).
- Added PEP 561 `py.typed` marker for strict type checking support.
- CLI console script entry point `blynx` and API server `blynx-api`.
