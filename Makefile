...
lint:
	python3 -m ruff check zymis/ apps/ tests/ --fix

format:
	python3 -m ruff format zymis/ apps/ tests/

typecheck:
	python3 -m mypy zymis/ --ignore-missing-imports
...
run-worker:
	$(PYTHON) -m zymis.worker.local_worker
